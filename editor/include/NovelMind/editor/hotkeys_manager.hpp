...
enum class KeyCode : i32 {
    ...
    // Editing
    Backspace = '\b', Tab = '\t', Enter = '\r', Escape = 0x1B,
    Space = ' ', Delete = 0x7F, Insert = 0x40000049,

    // Modifiers (for display purposes, not for binding)
    LeftShift = 0x400000E1, RightShift = 0x400000E5,
    LeftCtrl = 0x400000E0, RightCtrl = 0x400000E4,
    LeftAlt = 0x400000E2, RightAlt = 0x400000E6,
    LeftMeta = 0x400000E3, RightMeta = 0x400000E7,

    // Special
    PrintScreen = 0x40000046, ScrollLock = 0x40000047, Pause = 0x40000048,

    // Punctuation
    Minus = '-', Plus = '=', LeftBracket = '[', RightBracket = ']',
...
public:
     ...
     */
    [[nodiscard]] std::vector<const ShortcutCommand*> getCommandsInCategory(ShortcutCategory category) const;
...
private:
    ...
    std::unordered_map<ShortcutContext, std::unordered_map<Shortcut, std::string, ShortcutHash>> m_contextBindings;
