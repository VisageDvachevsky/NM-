...
void GraphDiffer::diffNodes(const VisualGraph& oldGraph, const VisualGraph& newGraph, GraphDiff& result) const
{
...
void GraphDiffer::diffEdges(const VisualGraph& oldGraph, const VisualGraph& newGraph, GraphDiff& result) const
{
...
IDNormalizer::createNormalizedCopy(const VisualGraph& graph) const
{
    ...
    for (const auto& edge : graph.getEdges())
    {
        ...
        {
            normalized->addEdge(srcIt->second, edge.sourcePort,
                               tgtIt->second, edge.targetPort);
        }
    }
...
RoundTripValidator::ValidationResult RoundTripValidator::validateTextRoundTrip(const std::string& nmScript)
{
...
RoundTripValidator::ValidationResult RoundTripValidator::validateFullRoundTrip(const std::string& nmScript)
{
    ValidationResult result;
    result.originalText = nmScript;
